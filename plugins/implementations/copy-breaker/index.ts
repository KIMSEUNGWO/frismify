...
import {pluginManagerProxy, toastManager} from "@/core";
...
export const copyProtectionBreakerPlugin: ExecutablePlugin = {
    ...
    onExecute: async (ctx) => {
        ...
        toastManager.success('Copy Protection Enabled', undefined, 'copy-breaker')
    },
...
function draw(div: HTMLDivElement) {
    div.style.background = 'linear-gradient(135deg, #A78BFA, #F472B6)';

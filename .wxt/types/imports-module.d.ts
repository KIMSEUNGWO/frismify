...
declare module '#imports' {
  ...
  export { Platform, Platform, platform, isMac, isWindows, isLinux, PlatformType, Platform } from '../utils/platform';
  export { getSetting, getSettingWithFallback, getSettingSchema, getDefaultValue, getAllDefaultSettings, hasSetting, getAllSettings, getSettingsWithSchema } from '../utils/settings';
}
